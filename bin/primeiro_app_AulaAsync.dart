...
solicitarNotas(int opcao) async {
  if (opcao == 1) {
    ...
    await calculoNotas(opcao, notaPrimBim, notaSegBim, notaTerBim, notaQuarBim);
    ...
    await calculoNotas(opcao, notaPrimTrim, notaSegTrim, notaTerTrim);
    ...
    await calculoNotas(opcao, notaPrimSem, notaSegSem);
  } else {
    print('Opção inválida');
  }
...
Future calculoNotas(int opcao, [double nota1, double nota2, double nota3, double nota4]){
  if (opcao == 1) {
    return Future.delayed(Duration(seconds: 3), () => print('A media aritmetica das suas notas é: ${(nota1+nota2+nota3+nota4) / 4}'));

  } else if (opcao == 2) {
    return Future.delayed(Duration(seconds: 3), () => print('A media aritmetica das suas notas é: ${(nota1+nota2+nota3) / 3}'));

  } else if (opcao == 3) {
    return Future.delayed(Duration(seconds: 3), () => print('A media aritmetica das suas notas é: ${(nota1+nota2) / 2}'));

  } else {
    return Future.delayed(Duration(seconds: 3), () => print('Opção inválida'));
  }
}
